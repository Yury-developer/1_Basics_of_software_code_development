package by.epamlab.linearPrograms;
...
public abstract class Block1 {
    ...
    public static void getResultTask1(int a, int b, int c) {
        String message = " 1.1 Найдите значение функции: z = ( (a – 3 ) * b / 2) + c";
        double z = ((a - 3) * b / 2) + c;
    ...
    public static void getResultTask2(double a, double b, double c) {
        String message = " 1.2 Вычислить значение выражения по формуле " +
    ...
    public static void getResultTask3(double x, double y) {
        String message = " 1.3 Вычислить значение выражения по формуле (sin x + cos y) / (cos x - sin y) * tg xy";
    ...
    public static void getResultTask4(double r) {
        String message = " 1.4 Дано действительное число R  вида nnn.ddd  " +
    ...
    public static void getResultTask5(int t) {
        String message = " 1.5 Дано  натуральное  число  Т,  которое  представляет  " +
    ...
    public static void getResultTask6(int x, int y) {
        String message = " 1.6 Для  данной  области  составить  линейную  программу,  " +
